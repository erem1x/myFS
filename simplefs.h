...
typedef struct {
	...
	int next_block; //chained list (next block)
	int block_in_file; //position in the file, if 0 we have a file control block
} BlockHeader;


//this is the first block of a chain, after the header
typedef struct{
